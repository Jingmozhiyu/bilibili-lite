...
const (
	...
	ErrorReason_USER_INVALID_ARGUMENT    ErrorReason = 1
	...
	ErrorReason_USER_ALREADY_EXISTS      ErrorReason = 6
	ErrorReason_USER_RATE_LIMITED        ErrorReason = 7
)
...
const file_user_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1auser/v1/error_reason.proto\x12\auser.v1*\xce\x01\n" +
	...
	"\x0eUSER_FORBIDDEN\x10\x05\x12\x17\n" +
	"\x13USER_ALREADY_EXISTS\x10\x06\x12\x15\n" +
	"\x11USER_RATE_LIMITED\x10\aB)\n" +
